<template>
    <div class="flex justify-center sm:justify-start items-center col-span-4 sm:col-span-3">
      {{ paginationStart }} - {{ paginationEnd }} de {{ total_items }} items
    </div>
    <div class="col-span-2"></div>
    <div class="flex justify-center col-span-4 mt-2 sm:mt-auto sm:justify-end">
