<template>
  <header class="w-full  bg-greenBrazil/90 fixed z-50 text-white font-roboto">
    <nav
    ...
    >
        ...
        <div class="flex">          
          <div class="md:hidden" @click="showMobileMenu">
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="w-6 h-6 text-yellowBrazil"
            >
              <path
      ...
      >
        <ul
          class="md:flex md:items-center z-[-1] md:z-auto md:static md:w-auto pb-6 md:p-auto bg-greenBrazil/90 md:bg-transparent  "
        ...
        >
          ...
          >
            <NuxtLink
              class="uppercase relative text-sm lg:text-2xl w-fit block after:block after:content-[''] after:absolute after:h-[2px] after:bg-yellowBrazil after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-center"
              :to="item.link"
